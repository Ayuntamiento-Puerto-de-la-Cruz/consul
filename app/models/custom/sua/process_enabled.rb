class SUA::ProcessEnabled
  ...
  def enabled?
    feature?("sua") && feature?(process_name) && setting["sua.process.#{process_name}"] && relatable?
  end
  ...
  private
    ...
    def relatable?
      ...
      (SUA::Related::RELATABLE_TYPES & [record_or_name.class.name, record_or_name]).any?
    end
end
